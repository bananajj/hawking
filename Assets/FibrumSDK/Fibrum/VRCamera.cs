...
public class VRCamera : MonoBehaviour { 
	...
	public void Init()
	{
		...
		if( blackFadeTex==null ) ifGoodFpsSoDoLensCorrection=false;
		...
		if( FibrumController.vrSetup == null )
		{
			...
			FibrumController.vrSetup = _setup.GetComponent<VRSetupGUI>(); 
		}
	...
	void LateUpdate () {
		...
		rotation = Quaternion.Euler(euler.x+mouseSensitivity*(oldMousePosition.y-Input.mousePosition.y),euler.y-mouseSensitivity*(oldMousePosition.x-Input.mousePosition.x),0f);
